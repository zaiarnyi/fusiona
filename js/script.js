...
$(function () {
    $(".list-portfolio__det").click(function () {
        $(".portfolio__main").removeClass("active");
        $(".portfolio__details").toggleClass("active");
    });
    $(".list-portfolio__slid").click(function () {
        $(".portfolio__main").removeClass("active");
        $(".portfolio__slides").toggleClass("active");
    });
    $(".btn-small__pro").click(function () {
        $(".portfolio__slides, .portfolio__details").removeClass("active");
        $(".portfolio__main").toggleClass("active");
    });
});
